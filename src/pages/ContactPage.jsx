            ...
            <Container fluid>
                <Row>
                    <Col xs={12} md={4} className="">
                        <div className="text-bg-warning p-3 h-100 d-flex flex-column justify-content-center">
                            ...
                            <Row>
                                <form ref={refForm} onSubmit={handleSubmit}>
                                    <Col sm={12} className="mb-2"><label className="h4">Nombre</label>
                                        <input className="d-block w-100 rounded border border-dark py-1 px-2 focus-ring focus-ring-secondary" type="text" name="nombre" /></Col>
                                    <Col sm={12} className="mb-2"><label className="h4">Correo Electronico</label>
                                        <input type="email" name="correo" className="d-block w-100 rounded border border-dark py-1 px-2 focus-ring focus-ring-secondary" /></Col>
                                    <Col sm={12} className="mb-2"><label className="h4">Mensaje</label>
                                        <textarea name="mensaje" className="d-block w-100 rounded border border-dark py-1 px-2 focus-ring focus-ring-secondary" /></Col>
